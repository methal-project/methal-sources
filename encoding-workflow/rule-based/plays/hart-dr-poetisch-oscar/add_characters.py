...
"""
Process character info for Poetisch Oscar and add it to the TEI file.
...
def add_character_infos_to_tei(df, teifn, teifn_with_characters,
    ...
    # add summary to front
    summary_div = etree.fromstring(
        add_summary_to_front(cf.summary_fpath, cf.summary_title))
    front.append(summary_div)
...
if __name__ == "__main__":
    ...
    os.system("xmllint --relaxng {} --format  {} > bla ; mv bla {}".format(
